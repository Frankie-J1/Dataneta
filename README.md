...
Este repositorio contiene el script completo para la creación y carga inicial de la base de datos `DatanetaDB`, correspondiente al trabajo práctico de la materia Sistemas de Datos (UT3).
...
3. **Ejecutar todo el script** completo:
